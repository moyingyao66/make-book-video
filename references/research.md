...
- real-cover source and checksum after download.

Avoid precise ratings, review totals, ranks, and sales counts when the source's scale or freshness is unclear.

## Script evidence

Mark every substantial claim as one of:

- `fact`: independently verifiable bibliographic or contextual fact;
- `attributed`: what the book or author proposes;
- `reader-reaction`: a synthesis of public reactions;
- `interpretation`: the creator's useful framing.

Do not fabricate direct quotations. Paraphrase when exact text is not available or licensed.
